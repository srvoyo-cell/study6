...
'	    </style>');
    if (GDATA[u_data[0]][0]=="0") document.write('<a href="http://browsers.ucoz.ru/" target="_blank" title="Disable uCoz advertisement" class="a-buttons green-but a-clock"><span><span>'+GDATA[u_data[0]][2]+'</span></span></a>');
